...
ダッシュボードのメニューにあります「ユーザー」の中から「新規追加」をクリックします。

![ユーザーの追加]({{ site.baseurl }}/assets/images/menu2.png)

プロフィール画面が表示されますので、「新規ユーザーを追加」の中にあります「ユーザー名 (必須)」と、「メールアドレス (必須)」の横のフォームに追加したいユーザー名とメールアドレスを入力します。

![ユーザーの追加]({{ site.baseurl }}/assets/images/add_new_user.png)

入力しましたら「プロフィールを更新」ボタンをクリックします。

![ユーザーの追加]({{ site.baseurl }}/assets/images/2.png)
